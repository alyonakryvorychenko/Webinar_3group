...
public class WebinarHomeWork1 {
    ...
    public static void test1() throws InterruptedException {
        ...
        Thread.sleep (3000);
        WebElement locatorLogin = driver.findElement(By.xpath("//input[@id='email']"));
        locatorLogin.sendKeys(login);

        //enter the password in "Email" field
        WebElement locatorPassword = driver.findElement(By.xpath("//input[@id='passwd']"));
        locatorPassword.sendKeys(password);

        // click the "Login" button
        WebElement submitButton = driver.findElement(By.xpath("//button[contains(@class, 'ladda-button')]"));
        submitButton.click();
        ...
        // log out from site
        WebElement profileLocator = driver.findElement(By.xpath("//span[@class='employee_avatar_small']"));
        profileLocator.click();
        WebElement logoutLocator = driver.findElement(By.xpath("//a[@id='header_logout']"));
        logoutLocator.click();
